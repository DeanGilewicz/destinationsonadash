					...
					<div class="lightbox-content">
						...
						<div class="container-lightbox-content">
							...
							<div class="lightbox-interaction">
								...
								<div class="area-one">
									<span class="previous" style="background-image:url('<?= get_stylesheet_directory_uri(); ?>/dist/icons/icon-facebook.svg');">PREV</span>
									<span class="image-comment"></span>
									<span class="next" style="background-image:url('<?= get_stylesheet_directory_uri(); ?>/dist/icons/icon-facebook.svg');">NEXT</span>
								</div>
